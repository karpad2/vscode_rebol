...
function activate(context) {
    ...
    const provider1 = vscode.languages.registerCompletionItemProvider("rebol", {
        provideCompletionItems(document, position, token, context) {
            ...
            const write_xml_docCompletion = new vscode.CompletionItem("write_xml_doc ");
            ...
            const close_btn_imgCompletion = new vscode.CompletionItem("close_btn_img ");
            ...
            const program_nazadCompletion = new vscode.CompletionItem("program_nazad ");
            ...
            const main_windowCompletion = new vscode.CompletionItem("main_window/user-data ");
            main_windowCompletion.kind = vscode.CompletionItemKind.Function;
            const faktura_kiirasCompletion = new vscode.CompletionItem("faktura_kiiras ");
    ...
    const slash = vscode.languages.registerCompletionItemProvider("rebol", {
        provideCompletionItems(document, position) {
            ...
            return [
                ...
                new vscode.CompletionItem("br_dok", vscode.CompletionItemKind.Variable),
                new vscode.CompletionItem("datum_dok", vscode.CompletionItemKind.Variable),
                new vscode.CompletionItem("sif_mag", vscode.CompletionItemKind.Variable),
                new vscode.CompletionItem("param", vscode.CompletionItemKind.Variable),
                new vscode.CompletionItem("prevoz", vscode.CompletionItemKind.Variable),
                new vscode.CompletionItem("iznos", vscode.CompletionItemKind.Variable),
                new vscode.CompletionItem("ukupno", vscode.CompletionItemKind.Variable),
                new vscode.CompletionItem("osn_por", vscode.CompletionItemKind.Variable),
                new vscode.CompletionItem("troskovi", vscode.CompletionItemKind.Variable),
                new vscode.CompletionItem("rabat", vscode.CompletionItemKind.Variable),
                new vscode.CompletionItem("size", vscode.CompletionItemKind.Variable),
            ];
        },
    }, "/" // triggered whenever a '/' is being typed
    );
    const sistime = vscode.languages.registerCompletionItemProvider("rebol", {
        provideCompletionItems(document, position) {
            // get all text until the `position` and check if it reads `console.`
            // and if so then complete if `log`, `warn`, and `error`
            const linePrefix = document
            ...
            return [
                new vscode.CompletionItem("", vscode.CompletionItemKind.Method),
                new vscode.CompletionItem("isodate", vscode.CompletionItemKind.Method),
            ];
        },
    }, "/" // triggered whenever a '/' is being typed
    );
    const doubledot = vscode.languages.registerCompletionItemProvider("rebol", {
        provideCompletionItems(document, position) {
            // get all text until the `position` and check if it reads `console.`
            // and if so then complete if `log`, `warn`, and `error`
            const linePrefix = document
